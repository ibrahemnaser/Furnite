  ...
  return (
    <>
      <LinksMenu show={isToggeled}>
        <LinksItems>
          <ListItem>
            <LinkStyled to="/Furnite/home">Home</LinkStyled>
          </ListItem>
          <ListItem>
            <LinkStyled to="/Furnite/products">Products</LinkStyled>
          </ListItem>
          <ListItem>
            <LinkStyled to="/Furnite/cart">Cart</LinkStyled>
          </ListItem>
        </LinksItems>
      ...
      <Container>
        <Wrapper>
          ...
          <Center>
            <Logo>
              <LinkStyledLogo to="/Furnite/home">Furnit.</LinkStyledLogo>
            </Logo>
          </Center>
          <Right>
            <MenuItem>
              <LinkStyled to="/Furnite/register">Register</LinkStyled>
            </MenuItem>
            <MenuItem>
              <LinkStyled to="/Furnite/login">Login</LinkStyled>
            </MenuItem>
            <MenuItem>
              <LinkStyled to="/Furnite/cart">
